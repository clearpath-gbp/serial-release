## serial (jazzy) - 2.0.1-1

The packages in the `serial` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release serial -t jazzy -r jazzy` on `Thu, 09 Jan 2025 10:33:07 -0000`
